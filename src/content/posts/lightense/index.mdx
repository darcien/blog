...
import shiromedia_penguin_frontImg from "../10-years-after-penguin-summer/shiromedia-penguin-front.jpg";
import bogorImg from "./bogor.jpg";
import catImg from "./cat.jpg";

> 2026-07-12: This website is no longer built with Hugo and no longer uses
> lightense for zoom. Some sentences in this post might no longer be true.
...
<Figure
  src={bogorImg}
  caption="One word, green. Behind the iron fence there is a river not visible in the photo. Also resized down to height=360px."
/>

<Figure
  src={shiromedia_penguin_frontImg}
  caption="This figure use global resource. The shortcode can handle both page and global resource. I don't understand why Hugo don't have this out of the box."
/>
