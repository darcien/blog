...
import buyee_statusImg from "./buyee-status.png";
import buyee_shipping_methodImg from "./buyee-shipping-method.png";
import buyee_air_bagImg from "./buyee-air-bag.jpg";
