...
<Figure
  src={package_tapestryImg}
  caption="How BOOTH.pm package their goods, it's a hard 1mm cardbox with no fillings."
/>

<Figure
  src={tapestryImg}
  caption="The B2 tapestry, unpacked and hanged on the wall. Drawn by Hatsuno-sensei and sold [here](https://booth.pm/en/items/5019934)."
  resize="x1440"
/>

<Figure
  src={tax_receiptImg}
  caption="I still don't understand how to calculate import tax on my own. Or how Indonesia's post office does not always give me this tax receipt. At least these days they have package notifications via WhatsApp business account."
  resize="x720"
/>
