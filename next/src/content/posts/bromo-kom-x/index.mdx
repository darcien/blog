...
import bike_box_bothImg from "./bike-box-both.jpg";
import bike_box_openImg from "./bike-box-open.jpg";
import elevation_graphImg from "./elevation-graph.jpg";
import climb_middleImg from "./climb-middle.jpg";
import race_packImg from "./race-pack.jpg";
import return_flightImg from "./return-flight.jpg";
import climb_final_2Img from "./climb-final-2.jpg";
import medalImg from "./medal.jpg";
import climb_final_3Img from "./climb-final-3.jpg";
import climb_final_1Img from "./climb-final-1.jpg";
import road_sideImg from "./road-side.jpg";
...
<Figure src={bike_box_openImg} caption="My bike packed in the Bonza hardcase bike box. My frame is 56 cm, the horizontal axis barely fits." />
...
<Figure src={race_packImg} caption="Commemorative photo with the race pack. Later on we jokingly said the only thing special about Bromo KOM X is the race pack. Usually it's just a pouch, but this year it's an actual backpack." />
...
<Figure src={bike_box_bothImg} caption="Mine and my friend's bike box. It's not very visible from the image, but my friend's one is longer and is an easy-fit one, so no need to release the bike handlebar." />
...
<Figure src={road_sideImg} caption="A photo I took during my rest. Yes it's foggy, we're up high in the mountain." />
...
<Figure src={climb_middleImg} caption="A photo taken by the event photographer. At this point, probably I'm in autopilot mode. No thoughts, just pedal." />
...
<Figure src={climb_final_1Img} caption="I like the expression of the cyclist next to me in this photo." />

<Figure src={climb_final_2Img} caption="A photo depicting the face of suffering during the final climb." />

<Figure src={climb_final_3Img} caption="You can see the fog is denser here, and the side view gives better perspective of the gradient." />
...
<Figure src={medalImg} caption="Commemorative photo with the medal. Same bike since 6 years ago, but different person 🦵. (Also, my bottle with the missing lid is in clear view here...)" />
...
<Figure src={return_flightImg} caption="I can see Madura island and Suramadu bridge from the plane. (Yes the window is dirty, I can't wipe it from my side.)" />
...
<Figure src={elevation_graphImg} caption="You can see the shape of the mountain from the graph." />
