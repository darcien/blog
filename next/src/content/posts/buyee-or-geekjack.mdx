...
import buyee_statusImg from "../../assets/img/buyee-status.png";
import buyee_shipping_methodImg from "../../assets/img/buyee-shipping-method.png";
import buyee_air_bagImg from "../../assets/img/buyee-air-bag.jpg";
...
<Figure src={buyee_statusImg} alt="Buyee order status" caption="Here's how it looks on Buyee's site" />
...
<Figure src={buyee_shipping_methodImg} alt="Buyee shipping methods" caption="These are the available methods at Buyee on March 2021" />
...
<Figure src={buyee_air_bagImg} alt="Air bag from buyee" caption="These are the air bags from Buyee" />
