...
import airgradient_box_openImg from "./airgradient-box-open.jpg";
import airgradient_back_sideImg from "./airgradient-back-side.jpg";
import airgradient_packageImg from "./airgradient-package.jpg";
import airgradient_on_wallImg from "./airgradient-on-wall.jpg";
import ha_dashboardImg from "./ha-dashboard.png";
import macbook_power_usageImg from "./macbook-power-usage.jpg";
import airgradient_assembledImg from "./airgradient-assembled.jpg";
import airgradient_unassembledImg from "./airgradient-unassembled.jpg";
import airgradient_boxesImg from "./airgradient-boxes.jpg";
import power_supplyImg from "./power-supply.jpg";
...
<Figure src={airgradient_unassembledImg} caption="Pre-soldered AirGradient kit that comes with the display and PM sensor already attached." />


<Figure src={airgradient_assembledImg} caption="Fully assembled kit, with everything sticked in." />
...
<Figure src={ha_dashboardImg} caption="My HA dashboard after connecting one AirGradient kit." />
...
<Figure src={macbook_power_usageImg} caption="A power meter showing 0.945 KWh after 6 days 15 hours 10 minutes for the server (from empty battery)." resize="x640" />
...
<Figure src={airgradient_packageImg} caption="AirGradient package that looks manually packaged by hand and sent from Thailand." resize="720x" />

<Figure src={airgradient_boxesImg} caption="Two boxes of AirGradient Pro DIY kit." resize="720x" />

<Figure src={airgradient_box_openImg} caption="First look after opening the kit." resize="x1080" />


### AirGradient

<Figure src={airgradient_on_wallImg} caption="AirGradient in action. Yes, the CO2 is high, my room has bad air circulation. Yes, the electric socket below has slight openings and is hazardous, I need to fix it eventually." />

<Figure src={airgradient_back_sideImg} caption="Back side view of AirGradient. To avoid punching a hole in the wall, I'm using knitting thread to hang the unit." resize="x720" />


### Others

<Figure src={power_supplyImg} caption="The 5V 3A power supply I'm using for powering AirGradient." resize="1080x" />
