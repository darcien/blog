...
<Figure
  src={airgradient_on_wallImg}
  caption="AirGradient in action. Yes, the CO2 is high, my room has bad air circulation. Yes, the electric socket below has slight openings and is hazardous, I need to fix it eventually."
/>

<Figure
  src={airgradient_back_sideImg}
