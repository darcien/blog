...
import isp_iconnet_testimonyImg from "../../assets/img/isp-iconnet-testimony.png";
import isp_oxygen_sales_reactImg from "../../assets/img/isp-oxygen-sales-react.jpg";
...
<Figure src={isp_iconnet_testimonyImg} alt="Screenshot of Iconnet landing page showing empty testimony section taken on 2023-04-26." caption="What makes this ISP even funnier is that their own landing page have an empty testimony section." />
...
<Figure src={isp_oxygen_sales_reactImg} alt="Oxygen.id sales reacted with tears of joy emoji to my inquiries" caption="Truly a 😂 moment." />
