...
<Figure src="/p/airgradient/airgradient-unassembled.jpg" caption="Pre-soldered AirGradient kit that comes with the display and PM sensor already attached." />


<Figure src="/p/airgradient/airgradient-assembled.jpg" caption="Fully assembled kit, with everything sticked in." />
...
<Figure src="/p/airgradient/ha-dashboard.png" caption="My HA dashboard after connecting one AirGradient kit." />
...
<Figure src="/p/airgradient/macbook-power-usage.jpg" caption="A power meter showing 0.945 KWh after 6 days 15 hours 10 minutes for the server (from empty battery)." resize="x640" />
...
<Figure src="/p/airgradient/airgradient-package.jpg" caption="AirGradient package that looks manually packaged by hand and sent from Thailand." resize="720x" />

<Figure src="/p/airgradient/airgradient-boxes.jpg" caption="Two boxes of AirGradient Pro DIY kit." resize="720x" />

<Figure src="/p/airgradient/airgradient-box-open.jpg" caption="First look after opening the kit." resize="x1080" />


### AirGradient

<Figure src="/p/airgradient/airgradient-on-wall.jpg" caption="AirGradient in action. Yes, the CO2 is high, my room has bad air circulation. Yes, the electric socket below has slight openings and is hazardous, I need to fix it eventually." />

<Figure src="/p/airgradient/airgradient-back-side.jpg" caption="Back side view of AirGradient. To avoid punching a hole in the wall, I'm using knitting thread to hang the unit." resize="x720" />


### Others

<Figure src="/p/airgradient/power-supply.jpg" caption="The 5V 3A power supply I'm using for powering AirGradient." resize="1080x" />
