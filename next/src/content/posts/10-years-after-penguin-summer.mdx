...
import shiromedia_penguin_frontImg from "../../assets/img/shiromedia-penguin-front.jpg";
import shiromedia_all_side_leftImg from "../../assets/img/shiromedia-all-side-left.jpg";
import shiromedia_all_side_rightImg from "../../assets/img/shiromedia-all-side-right.jpg";
import shiromedia_nanana_frontImg from "../../assets/img/shiromedia-nanana-front.jpg";
import shiromedia_nanana_backImg from "../../assets/img/shiromedia-nanana-back.jpg";
import shiromedia_penguin_no_jacketImg from "../../assets/img/shiromedia-penguin-no-jacket.jpg";
import shiromedia_penguin_jacket_onlyImg from "../../assets/img/shiromedia-penguin-jacket-only.jpg";
import shiromedia_penguin_bookmarkImg from "../../assets/img/shiromedia-penguin-bookmark.jpg";
...
<Figure src={shiromedia_penguin_frontImg} caption="Front side of 'Penguin Summer'" />
...
<Figure src={shiromedia_all_side_leftImg} caption="Every LN published by Shiromedia. Ordered by publish date from left (oldest) to right (newest)." />

<Figure src={shiromedia_all_side_rightImg} />
...
<Figure src={shiromedia_nanana_frontImg} />

<Figure src={shiromedia_nanana_backImg} />


## Omake 2 - Extra photos

<Figure src={shiromedia_penguin_no_jacketImg} />

<Figure src={shiromedia_penguin_jacket_onlyImg} />

<Figure src={shiromedia_penguin_bookmarkImg} caption="'Penguin Summer' bookmark bonus from first press release." />
