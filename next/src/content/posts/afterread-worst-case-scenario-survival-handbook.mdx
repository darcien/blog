...
import book_cover_worst_case_scenario_handbookImg from "../../assets/img/book-cover-worst-case-scenario-handbook.jpg";
...
<Figure src={book_cover_worst_case_scenario_handbookImg} caption="Cover of the book 'The Worst-Case Scenario Survival Handbook' by Joshua Piven and David Borgenicht" resize="x480" />
