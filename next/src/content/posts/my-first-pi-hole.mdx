...
import first_pi_hole_admin_consoleImg from "../../assets/img/first-pi-hole-admin-console.png";
...
<Figure src={first_pi_hole_admin_consoleImg} alt="Admin console of Pi-hole" caption="I'm feeling happy when looking at the queries blocked number going up." />
