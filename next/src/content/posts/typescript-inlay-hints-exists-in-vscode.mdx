...
import til_inlay_hintImg from "../../assets/img/til-inlay-hint.png";
...
<Figure src={til_inlay_hintImg} alt="Comparison of TS inlay hints off vs on." caption="Comparison of TS inlay hints turned off vs on. Left is off; right is on." />
