...
<Figure src="/img/til-inlay-hint.png" alt="Comparison of TS inlay hints off vs on." caption="Comparison of TS inlay hints turned off vs on. Left is off; right is on." />
