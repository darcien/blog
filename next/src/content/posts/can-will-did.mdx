...
import bernard_rollImg from "../../assets/img/bernard-roll.gif";
...
<Figure src={bernard_rollImg} alt="gif showing the built random number picker in Discord" caption="Showcase of Bernard in action" />
